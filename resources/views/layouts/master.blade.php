...
<div class="wrapper">
	<div class="page-header page-header-small">
		    ...
		    <div class="page-header-image" data-parallax="true" style="background-image: url('/hospital.jpg');">
		    </div>
	...
	<footer class="footer footer-default " >
	    ...
	    <div class="container">
	        ...
	        <div class="copyright">
	            &copy; <script>document.write(new Date().getFullYear())</script>, Designed by <a href="http://www.invisionapp.com">Invision</a>. Coded by <a href="https://www.creative-tim.com">Creative Tim</a>.
	        </div>
	    </div>
	</footer>
